...
let state = { counter: 0, postIndex: 0, posted: [], lastBrand: null, lastSector: null, lastScore: 0, lastTwoHadYear: [true, true] };
...
console.log('No year (sc<year) count:', seq.filter(p => !p.year).length, '/', seq.length);
